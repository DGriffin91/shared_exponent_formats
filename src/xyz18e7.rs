...
pub fn xyz18e7_to_vec3(v: (u32, u32)) -> [f32; 3] {
    ...
    let xsign = bitfield_extract(v.1, 22, 1) as f32 * 2.0 - 1.0;
    let ysign = bitfield_extract(v.1, 23, 1) as f32 * 2.0 - 1.0;
    let zsign = bitfield_extract(v.1, 24, 1) as f32 * 2.0 - 1.0;
